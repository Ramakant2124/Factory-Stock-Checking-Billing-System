...
class supplierClass:
    def __init__(self,root):
      ...
      #====options===
        #lbl_search=Label (self.root,text=" Invoice No.",bg="gray",font=("goudy old style",15)).place(x=700,y=10)
       
       
       # txt_Search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=850,y=80)
        #btn_Search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white").place(x=410,y=9,width=150,height=30)
        
        #=====title===
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="yellow",fg="#010c48").place(x=50,y=10,width=1000,height=40)
        
        
        #=====conetent======
        #====row1=====
        lbl_supplier_invoice=Label(self.root,text="Invoice No",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=80)
        ...
        #=======row 2=======
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120,width=180)
       
        #=======row 3 =======
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=160)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow").place(x=180,y=160,width=180)
         ...
         #=======row 4 =======
        lbl_desc=Label(self.root,text="Description",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=220)

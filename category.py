...
class categoryClass:
    def __init__(self,root):
     ...
     #===================title====================   
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style",20,"bold"),bg="yellow",fg="#010c48").place(x=50,y=10,width=1000,height=40)   
        
        lbl_name=Label(self.root,text="Enter Category Name ",font=("goudy old style",30,"bold"),bg="#F9F5B0").place(x=50,y=100)   
    ...
    def add(self): 
      ...
      try:
          if self.var_name.get()=="":
            messagebox.showerror("Error","Category Name sholud be required",parent=self.root)
          else:
    ...
    def delete(self):
      ...
      try:
          if self.var_cat_id.get()=="":
            messagebox.showerror("Error","please select or  ctegory from the list",parent=self.root)
          else:

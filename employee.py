...
class employeeClass:
    def __init__(self,root):
      ...
      #====options===
        ...
        #=====title===
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="yellow",fg="#010c48").place(x=50,y=100,width=1000)
        
        
        #=====conetent======
        #====row1=====
        lbl_empide=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=150)
        lbl_gender=Label(self.root,text="Gender",font=("goudy old style",15),bg="#F9F5B0").place(x=350,y=150)
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="#F9F5B0").place(x=750,y=150)
        ...
        #=======row 2=======
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="#F9F5B0").place(x=350,y=190)
        lbl_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="#F9F5B0").place(x=750,y=190)
        ...
        #=======row 3 =======
        lbl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=230)
        lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="#F9F5B0").place(x=350,y=230)
        lbl_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="#F9F5B0").place(x=750,y=230)
        ...
        txt_utype=Entry(self.root,textvariable=self.var_utype,font=("goudy old style",15),bg="white").place(x=850,y=230,width=180)
        ...
        cmb_utype.current(0)
         ...
         #=======row 4 =======
        lbl_city=Label(self.root,text="City",font=("goudy old style",15),bg="#F9F5B0").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="#F9F5B0").place(x=500,y=270)
        
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15),bg="lightyellow").place(x=150,y=270,width=180)
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","email","gender","contact","dob","doj","pass","utype","city","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
          ...
          if self.var_emp_id.get()=="":
            ...
            if row!=None:
              messagebox.showerror("Error","This Employee ID already assigned,try different",parent=self.root)
                ...
                cur.execute("Insert into employee (eid,name,email,gender,contact,dob,doj,pass,utype,city,salary) values(?,?,?,?,?,?,?,?,?,?,?)",(
                                    self.var_emp_id.get(),
                                    self.var_name.get(),
                                    self.var_email.get(),
                                    self.var_gender.get(),
          ...
          if self.var_emp_id.get()=="":
            ...
            if row==None:
              messagebox.showerror("Error","Invalide Employee ID",parent=self.root)
                ...
                cur.execute("Update employee set name=?,email=?,gender=?,contact=?,dob=?,doj=?,pass=?,utype=?,city=?,salary=? where eid=?",(
